...
struct CyclingRecordsView: View {
    ...
    var body: some View {
        Section(header: Text(RecordsFormatting.headerStrings[0]), footer: Text(RecordsFormatting.getCyclingRecordsFooterText(usingMetric: newPreferences.usingMetric))) {
            VStack {
                HStack {
                ...
                CyclingSingleRecordView(recordValue: MetricsFormatting.formatDistance(distance: records.storedRecords[0].longestCyclingDistance, usingMetric: newPreferences.usingMetric), recordName: RecordsFormatting.recordsStrings[3], recordDate: RecordsFormatting.formatOptionalDate(date: records.storedRecords[0].longestCyclingDistanceDate), firstEntry: true)
            ...
            VStack {
                ...
                CyclingSingleRecordView(recordValue: MetricsFormatting.formatDistance(distance: records.storedRecords[0].totalCyclingDistance, usingMetric: newPreferences.usingMetric), recordName: RecordsFormatting.recordsStrings[0], recordDate: nil, firstEntry: true)
